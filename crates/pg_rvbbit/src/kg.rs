//! SQL-native knowledge graph catalog and traversal helpers.
//!
//! This first slice keeps the executor simple: graph writes and reads are
//! ordinary SQL/PLpgSQL over Rvbbit-owned catalog tables. Later extraction
//! layers (`triples`, rule-derived edges, table stewards) can all land facts
//! here without changing the public graph API.

use pgrx::extension_sql;

extension_sql!(
    r#"
-- SQL-native knowledge graph -------------------------------------------------

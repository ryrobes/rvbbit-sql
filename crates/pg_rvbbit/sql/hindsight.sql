-- Generic memory-service registry plus Hindsight-specific helpers.
--
-- Warren registers deployed memory services here. The Rust UDFs in
-- hindsight.rs resolve this registry and call Hindsight over HTTP.

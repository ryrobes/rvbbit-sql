-- Upgrade pg_rvbbit 2.0.16 -> 2.0.17
--
-- Carry the default-embedder promotion SQL for databases that were already on
-- 2.0.16 before the capability-driven default embedder path existed.

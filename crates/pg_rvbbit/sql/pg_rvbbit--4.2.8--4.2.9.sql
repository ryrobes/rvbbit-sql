-- Upgrade pg_rvbbit 4.2.8 -> 4.2.9
--
-- Add the durable source-shape profiles and normalized document-brain work
-- projection used by Calliope Personal Briefs. User visibility and assignment
-- remain read-time concerns enforced through brain_visible_docs(email).

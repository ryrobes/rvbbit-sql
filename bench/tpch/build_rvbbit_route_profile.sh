...
DEFAULT_SYSTEMS="rvbbit_native,rvbbit_duck_forced,rvbbit_datafusion_forced,rvbbit_pg_heap_forced"
if [ "${RVBBIT_ROUTE_INCLUDE_HIVE:-1}" != "0" ]; then
    DEFAULT_SYSTEMS="rvbbit_native,rvbbit_duck_forced,rvbbit_duck_hive_forced,rvbbit_datafusion_forced,rvbbit_datafusion_hive_forced,rvbbit_pg_heap_forced"
fi
